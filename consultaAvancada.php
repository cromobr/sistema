...
<thead>
    ...
    <tr class="<?=$class?>">
        ...
        <td style="width: 80; text-align: right;"> <?=number_format($dados['VALOR_FOB_DOLAR'],2,",",".")?></td>
        <td style="width: 80; text-align: right;"> <?=number_format($dados['QUANTIDADE_VALOR_SEGURO_DOLAR'],2,",",".")?></td>
        <td style="width: 80; text-align: right;"> <?=number_format($dados['QUANTIDADE_VALOR_FRETE_DOLAR'],2,",",".")?></td>
        <td style="height: 110; "> <?=str_replace(",",", ",$dados['DESCRICAO_DETALHADA'])?></td>
    </tr>
    <?php
        if ($class == "a")
            $class ="b";
