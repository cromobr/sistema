<?php ob_start();
    ...
    //echo $pais;
    $sql = geraSQLConsultaAvancada($_SESSION["descricao1"],$_SESSION["ncm"],$_SESSION["valorUnitarioIni"],$_SESSION["valorUnitarioFin"],$_SESSION["dataInicial"],$_SESSION["dataFinal"],$_SESSION["paginaAtual"],$_SESSION["qtdPagina"],$pais);
    //echo $sql;
    $arq = "";
    ...
    <table border='0'>
        ...
        <tr >
            <td style='background-color: darkblue; color: white;' colspan='6'> 
                EQUADOR IMPORTAÇÃO DETALHADA / DESCRIÇÃO DE MARCAS
            </td>            
        </tr>
        <tr >
