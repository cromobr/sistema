...
$sql = geraSQLConsultaAvancada($_SESSION["descricao1"],$_SESSION["ncm"],$_SESSION["valorUnitarioIni"],$_SESSION["valorUnitarioFin"],$_SESSION["dataInicial"],$_SESSION["dataFinal"],$tampag,$qtd,"");
...
<thead>
    ...
    <tr class="<?=$class?>">
        ...
        <td style="width: 500; text-align: left;"> <?=$dados['IMPORTADORESDOSETOR1']?></td>
